...
1. Graph-structured modeling of power grids  
2. Implementations of multiple GNN architectures:
  - GCN  
  - GraphSAGE  
  - GAT  
3. Hybrid solver: GNN warm-start for AC-OPF solvers  
4. PPO reinforcement learning module (optional)  
